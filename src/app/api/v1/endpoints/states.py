...
from app.models import StatesModel, UserModel
from app.schemas.stateSchema import StatesSchemaBase, StatesSchemaResponse, StatesSchemaWithRelations, StatesSchemaWithRelationsResponse, StateFilters
from app.schemas.ResponseSchema import NoAuthenticatedResponse, InternalServerResponse, ConflictResponse, NotFoundResponse

from app.utils.querys_db import search_all_items_in_db, search_item_in_db
from app.utils.exceptions import ConflictException, UniqueViolationException, InternalServerException, NotFoundException, UnauthorizedException
...
async def create(data: StatesSchemaBase, 
    ...
    O endpoint requer:
    - name (nome do estado) (unico)
    - uf (sigla do estado) (unico)
    
    o ID é gerado de forma automatica, se caso o usuário tente adicionar
